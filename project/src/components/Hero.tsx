...
const Hero = () => {
  ...
  <h1 className="text-6xl md:text-8xl font-bold mb-6 bg-gradient-to-r from-neon-mint via-teal-glow to-neon-mint bg-clip-text text-transparent animate-pulse font-azonix neon-glow">
          ALTVERSE 2025
        </h1>
        
  <div className="text-xl md:text-2xl text-soft-white/90 mb-8 space-y-2 font-azonix">
        ...
        <div className="mt-12">
          <button 
            ...
            className="group relative px-12 py-4 text-lg font-bold text-soft-white bg-gradient-to-r from-neon-mint/20 to-teal-glow/20 tri-cut overflow-hidden transition-all duration-300 hover:scale-105 neon-border font-azonix"
          >
