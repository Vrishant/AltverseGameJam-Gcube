    ...
    <section id="register" className="py-20 px-4 bg-gradient-to-b from-gunmetal to-onyx relative">
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-teal-glow to-neon-mint bg-clip-text text-transparent font-azonix">
            Register Now
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="bg-gunmetal/50 tri-cut p-6 neon-border">
              <h4 className="text-xl font-bold text-neon-mint mb-3 font-azonix">
          ...
          <div className="text-center">
            <div className="bg-gradient-to-br from-gunmetal/80 to-onyx/80 tri-cut p-12 neon-border glass">
              <div className="mb-8">
                ...
                <h3 className="text-3xl font-bold text-soft-white mb-4 font-azonix">
                  Secure Your Spot
                </h3>
              ...
              <a href="https://docs.google.com/forms/d/e/1FAIpQLSeHyrN06AaiNM9i60tRk1f5t9SouqKpLAB0GrU1Ahok2urR3A/viewform?usp=header">
              <button className="group relative w-full px-8 py-4 text-lg font-bold text-soft-white bg-gradient-to-r from-neon-mint/20 to-teal-glow/20 tri-cut overflow-hidden transition-all duration-300 hover:scale-105 neon-border mb-6 font-azonix" >
        ...
        <div className="mt-16 text-center">
          <div className="bg-gradient-to-r from-neon-mint/8 to-teal-glow/8 tri-cut p-8 neon-border">
            <h3 className="text-2xl font-bold text-neon-mint mb-4 font-azonix">
              Don't Miss Out!
            </h3>
