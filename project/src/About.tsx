...
const About: React.FC = () => {
  ...
  <h1 className="text-4xl font-bold mb-4 font-azonix">Our Story</h1>
      ...
      <section className="max-w-3xl w-full mb-16 text-center">
  <h2 className="text-3xl font-semibold mb-3 font-azonix">Team</h2>
      ...
      <section className="max-w-3xl w-full mb-16 text-center">
  <h2 className="text-3xl font-semibold mb-3 font-azonix">Mission & Vision</h2>
  ...
  <h2 className="text-2xl font-semibold mb-2 font-azonix">Get in Touch</h2>
